' BCardLayout shows exactly one child ("card") at a time - two pages
' here, switched by a Next button click.
...
app = HApplicationCreate("application/x-vnd.EbHaiku-CardLayoutExample")

DIM w AS HWindow
w = HWindowCreate(100, 100, 360, 220, "eb-haiku card layout example", H_QUIT_ON_WINDOW_CLOSE)
